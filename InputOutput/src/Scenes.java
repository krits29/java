...
//        }
    ...
    static //copy of static data to keep all data consistent
    {
        ...
        try
        {
            scan = new Scanner(new BufferedReader(new FileReader("locations.txt")));  //rather than system.in
        ...
        try
        {
            ...
            while(scan.hasNextLine())
            {
                ...
                try // had to add this in a try block becuase it wasn't working before
